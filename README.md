...
We use tokens as ankind of ID which is saved in the local storage and the user can access or login thru that.
...
Server process, deliver and store webpages to the user.
